...
export default function UserEditPage() {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const result = await BACKEND_API.getUserById(userId, accessToken);
                ...
                if (result.status) {
                    ...
                    toast.error(result.data.message || "Failed to load user");
                }
    ...
    const validateForm = () => {
        ...
        // Password is optional for edit, but if entered, must be valid
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await BACKEND_API.usersUpdate(userId, updateData, accessToken);
