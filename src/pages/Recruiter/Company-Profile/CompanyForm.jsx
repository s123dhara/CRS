...
const CompanyForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { status, message } = await BACKEND_API.recruiterCompanyProfile(formData, loggedUser);
            if (status) {
    ...
    return (
        <div className="min-h-screen bg-violet-500 flex items-center justify-center px-4 py-10">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-3xl">
                <h2 className="text-3xl font-bold text-violet-700 mb-6 text-center">Company Registration</h2>
