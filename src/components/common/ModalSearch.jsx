  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Search form */}
          <form className="border-b border-gray-20">
            <div className="relative">
              ...
              <input
                id={searchId}
                className="w-full dark:text-gray-300 bg-white border-none outline-none focus:ring-transparent placeholder-gray-400  appearance-none py-3 pl-10 pr-4"
                type="search"
